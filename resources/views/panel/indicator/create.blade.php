                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                        ...
                                        <select name="header" class="form-control" id="header">
                                            <option value="info">سربرگ فارسی آداک همراه (Info)</option>
                                            <option value="sale">سربرگ فارسی آداک همراه (Sale)</option>
                                            <option value="english">سربرگ انگلیسی آداک همراه</option>
                                        </select>
                                        @error('header')
                                        <div class="invalid-feedback text-danger d-block">{{ $message }}</div>
                                        @enderror
